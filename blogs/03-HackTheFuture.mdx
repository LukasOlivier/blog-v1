...
date: 09/11/23
description: A hackathon organized by the Cronos Group
image: /img/htf.jpg
---
...
<div style={{ display: 'flex', justifyContent: 'space-between' }}>
    <img src="/img/htf2.jpeg" style={{ width: '48%', maxWidth: '800px' }} />
    <img src="/img/htf3.jpeg" style={{ width: '48%', maxWidth: '800px', objectFit: 'contain' }} />
</div>
