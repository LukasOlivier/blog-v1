...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '5%', justifyContent: 'center'}}>
    <img src="/img/brandy3.jpeg" style={{ flexGrow: '1', maxWidth: '30rem', height: '300px', objectFit: 'cover' }} />
    <img src="/img/brandy4.jpg" style={{ flexGrow: '1',  maxWidth: '30rem', height: '300px', objectFit: 'cover' }} />
    <img src="/img/brandy2.jpeg" style={{ flexGrow: '1',  maxWidth: '30rem', height: '300px', objectFit: 'cover' }} />
    <img src="/img/brandy5.png" style={{ flexGrow: '1',  maxWidth: '30rem', height: '300px', objectFit: 'cover' }} />
</div>
