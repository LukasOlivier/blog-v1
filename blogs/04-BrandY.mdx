...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
    <img src="/img/brandy3.jpeg" style={{ width: '100%', height: '300px', objectFit: 'cover' }} />
    <img src="/img/brandy4.jpg" style={{ width: '100%', height: '300px', objectFit: 'cover' }} />
    <img src="/img/brandy2.jpeg" style={{ width: '100%', height: '300px', objectFit: 'cover' }} />
    <img src="/img/brandy5.png" style={{ width: '100%', height: '300px', objectFit: 'cover' }} />
</div>
